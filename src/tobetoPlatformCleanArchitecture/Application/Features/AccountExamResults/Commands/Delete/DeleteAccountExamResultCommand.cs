...
public class DeleteAccountExamResultCommand : IRequest<DeletedAccountExamResultResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
