...
namespace Application.Features.AccountLearningPaths.Commands.Update.UpdateAccountLearningPathIsLiked;
public class UpdateAccountLearningPathIsLikedCommand : IRequest<UpdatedAccountLearningPathResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{   
    ...
    public class UpdateAccountLearningPathIsLikedCommandHandler : IRequestHandler<UpdateAccountLearningPathIsLikedCommand, UpdatedAccountLearningPathResponse>
    {
        ...
        public UpdateAccountLearningPathIsLikedCommandHandler(IMapper mapper, IAccountLearningPathRepository accountLearningPathRepository,
        ...
        public async Task<UpdatedAccountLearningPathResponse> Handle(UpdateAccountLearningPathIsLikedCommand request, CancellationToken cancellationToken)
        {
