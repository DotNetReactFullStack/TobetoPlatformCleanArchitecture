...
public class DeleteClassroomExamCommand : IRequest<DeletedClassroomExamResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
