...
public class CreateAccountAnnouncementCommand : IRequest<CreatedAccountAnnouncementResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
