...
public class DeleteAccountAnnouncementCommand : IRequest<DeletedAccountAnnouncementResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
