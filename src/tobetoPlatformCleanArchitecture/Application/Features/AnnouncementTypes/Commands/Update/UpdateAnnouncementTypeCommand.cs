...
public class UpdateAnnouncementTypeCommand : IRequest<UpdatedAnnouncementTypeResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
