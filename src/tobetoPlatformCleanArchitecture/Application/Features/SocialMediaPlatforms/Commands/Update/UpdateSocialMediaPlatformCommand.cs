...
public class UpdateSocialMediaPlatformCommand : IRequest<UpdatedSocialMediaPlatformResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
