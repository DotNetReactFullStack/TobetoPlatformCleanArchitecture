...
public class DeleteAccountRecourseCommand : IRequest<DeletedAccountRecourseResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
