...
public class CreateOrganizationCommand : IRequest<CreatedOrganizationResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
