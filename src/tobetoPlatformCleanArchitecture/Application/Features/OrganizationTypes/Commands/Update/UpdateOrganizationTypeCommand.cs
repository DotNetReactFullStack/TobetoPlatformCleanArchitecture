...
public class UpdateOrganizationTypeCommand : IRequest<UpdatedOrganizationTypeResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
