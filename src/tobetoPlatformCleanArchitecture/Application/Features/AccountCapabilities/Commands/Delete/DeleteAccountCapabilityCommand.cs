...
public class DeleteAccountCapabilityCommand : IRequest<DeletedAccountCapabilityResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
