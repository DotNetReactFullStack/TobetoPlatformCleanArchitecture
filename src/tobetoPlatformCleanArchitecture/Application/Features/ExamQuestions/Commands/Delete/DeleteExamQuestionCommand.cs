...
public class DeleteExamQuestionCommand : IRequest<DeletedExamQuestionResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
