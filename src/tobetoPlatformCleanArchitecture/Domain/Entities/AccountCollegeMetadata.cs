...
public class AccountCollegeMetadata : Entity<int>
{
    ...
    public AccountCollegeMetadata()
    {
        
    }

    public AccountCollegeMetadata(int id, int accountId, int graduationStatusId, int collegeId, int educationProgramId, bool visibility, DateTime startingYear, DateTime graduationYear, bool programOnGoing) : this()
    {
        Id = id;
        AccountId = accountId;
