...
public class OperationClaimConfiguration : IEntityTypeConfiguration<OperationClaim>
{
    ...
    private HashSet<OperationClaim> getSeeds()
    {
        ...
        #endregion
        #region LearningPathCategories
        seeds.Add(new OperationClaim { Id = ++id, Name = "LearningPathCategories.Admin" });
        seeds.Add(new OperationClaim { Id = ++id, Name = "LearningPathCategories.Read" });
        seeds.Add(new OperationClaim { Id = ++id, Name = "LearningPathCategories.Write" });
        seeds.Add(new OperationClaim { Id = ++id, Name = "LearningPathCategories.Add" });
        ...
        #endregion
        #region RecourseDetailSteps
        seeds.Add(new OperationClaim { Id = ++id, Name = "RecourseDetailSteps.Admin" });
        seeds.Add(new OperationClaim { Id = ++id, Name = "RecourseDetailSteps.Read" });
        seeds.Add(new OperationClaim { Id = ++id, Name = "RecourseDetailSteps.Write" });
        seeds.Add(new OperationClaim { Id = ++id, Name = "RecourseDetailSteps.Add" });
