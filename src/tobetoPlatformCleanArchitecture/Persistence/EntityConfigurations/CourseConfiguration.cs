...
public class CourseConfiguration : IEntityTypeConfiguration<Course>
{
    ...
    private HashSet<Course> getSeeds()
    {
        ...
        HashSet<Course> seeds =
            new()
            {
                    new Course { Id = ++id, CourseCategoryId= 1, Name= "Yazılım Geliştirici Yetiştirme Kampı", TotalDuration = 50, Priority= 1, IsActive= true },
                    ...
                    new Course { Id = ++id, CourseCategoryId= 3, Name= "Proje Aşamaları", TotalDuration = 1, Priority= 1, IsActive= true },
                    new Course { Id = ++id, CourseCategoryId= 3, Name= "Kampüs Buluşmaları", TotalDuration = 1, Priority= 1, IsActive= true },
                    ...
                    new Course { Id = ++id, CourseCategoryId= 1, Name= "Yemek Siparişi Uygulaması", TotalDuration = 720, Priority= 1, IsActive= true },
