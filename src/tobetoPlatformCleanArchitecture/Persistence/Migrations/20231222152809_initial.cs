        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecourseId = table.Column<int>(type: "int", nullable: true),
                    RecourseStepId = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "admin@admin.com", "Admin", "NArchitecture", new byte[] { 179, 118, 130, 78, 149, 113, 201, 199, 89, 210, 124, 154, 77, 65, 216, 15, 5, 145, 5, 132, 81, 240, 231, 58, 6, 234, 166, 117, 170, 91, 213, 247, 187, 2, 16, 150, 84, 169, 174, 122, 184, 148, 107, 24, 41, 99, 203, 61, 158, 75, 37, 134, 202, 231, 109, 153, 140, 24, 91, 104, 1, 35, 45, 113 }, new byte[] { 238, 176, 224, 208, 144, 114, 1, 40, 80, 115, 82, 207, 7, 205, 44, 171, 76, 58, 221, 128, 70, 181, 92, 25, 195, 123, 50, 46, 20, 208, 195, 94, 43, 90, 7, 60, 197, 106, 104, 218, 57, 143, 45, 9, 2, 221, 158, 231, 54, 77, 62, 85, 100, 2, 147, 209, 230, 5, 42, 212, 135, 137, 104, 115, 203, 238, 94, 194, 201, 227, 46, 68, 216, 96, 189, 93, 52, 122, 45, 25, 80, 58, 169, 228, 109, 14, 212, 165, 88, 250, 130, 49, 148, 226, 245, 178, 103, 36, 39, 164, 211, 234, 201, 33, 126, 162, 142, 33, 58, 116, 196, 180, 162, 190, 197, 206, 214, 2, 85, 224, 96, 50, 48, 148, 197, 38, 24, 137 }, true, null });
